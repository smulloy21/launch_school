# Write a reject function that mimics the select function you just wrote, but
# that rejects rather than selects elements from the iterable object. That is,
# it should return a list of all the elements of the iterable for which the
# callback function doesn't return a truthy value. It should only include any
